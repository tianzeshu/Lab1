...
public class Tree { // 以邻接表方式构建图
	...
	public int slen;
	public int elen;
	public static VNode[] mVexs; // 顶点数组
	public ENode[] bridgeWord;
	public int bridgeCount = 0;
	public ENode newtest = new ENode();
	...
	public ENode[] queue = new ENode[100];
	public int queueFront = 0, queueBack = 0;
